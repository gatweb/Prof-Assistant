...
if (saisie === null || saisie.trim() === "") {
    ...
    afficher("Les 3 premiers caractères", pseudo.slice(0, 3));
...
**Note :** \`.map()\` transforme chaque élément d'un tableau — on le verra en détail avec les tableaux. Tu peux aussi le faire avec une boucle \`for\` classique.
            `.trim()
        }
    }
];
