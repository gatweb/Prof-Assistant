...
const EXERCICES = [
    {
        ...
        lien_cours: "https://docs.google.com/document/d/1USkPqIk7Zbx7-aEV9Zp9cUQ4b4fG5X5NprhbIL3X9gA/edit?tab=t.0",
        enonce_md: `
...
Voici comment organiser ta structure logique de saisie, de validation et d'affichage. Complète les morceaux avec \`...\` :
...
// Validation groupée : on s'assure qu'aucune variable n'est null ou vide
if (prenom === null     || prenom.trim()     === "" ||
    ...
    // Si toutes les saisies sont valides, on affiche la carte de visite
...
Identifie le premier problème et pose une question socratique ciblée.`,
            ...
            niveau_3_md: `
🛠️ **Squelette logique et formules attendues :**
 
Voici l'architecture de double validation (d'abord \`null\` puis \`isNaN\`) et les calculs de conversion. Complète les morceaux avec \`...\` :
...
if (saisie === null) {
    ...
    if (isNaN(celsius)) {
        ...
        // Applique les formules de conversion
...
**💡 Bonus :** Essaie de saisir **-40** dans ton convertisseur ! Tu verras un résultat amusant : -40°C est exactement égal à -40°F. C'est le seul point de croisement des deux échelles.
            `.trim()
        }
    }
];
